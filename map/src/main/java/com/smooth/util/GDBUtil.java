...
public class GDBUtil {
  public  static final String DEFAULT_FEATURE_SERVICE_URL = "http://sampleserver6.arcgisonline.com/arcgis/rest/services/Sync/WildfireSync/FeatureServer";

    public  static final String DEFAULT_BASEMAP_SERVICE_URL = "http://services.arcgisonline.com/ArcGIS/rest/services/ESRI_StreetMap_World_2D/MapServer";

    public   static final String DEFAULT_GDB_PATH = "/ArcGIS/samples/OfflineEditor/";

    public  static final String DEFAULT_BASEMAP_FILENAME = "/ArcGIS/samples/OfflineEditor/SanFrancisco.tpk";

    public  static final int[] FEATURE_SERVICE_LAYER_IDS = { 0, 1, 2 };
    ...
    public  static void synchronize(final OfflineEditorActivity activity) {
        showProgress(activity, true);
    ...
    public static void showProgress(final OfflineEditorActivity activity, final boolean b) {
    ...
    public  static void showMessage(final OfflineEditorActivity activity, final String message) {
        activity.runOnUiThread(new Runnable() {
